...
class TestConfidenceBasedFilter:
    ...
    def test_filter_by_confidence_threshold(self):
        ...
        recommendations = [
            ...
            {"id": "2", "title": "Medium Confidence", "confidence": 0.65, "priority": 7},
    ...
    def test_deduplication(self):
        ...
        recommendations = [
            ...
            {"id": "2", "title": "add database", "confidence": 0.7, "priority": 7},  # Duplicate (case-insensitive)
...
class TestHighPrecisionRequirements:
    ...
    def test_quality_over_quantity(self):
        ...
        recommendations = [
            {"id": str(i), "title": f"Rec {i}", "confidence": 0.9 if i < 2 else 0.4, "priority": i}
            for i in range(10)
        ]
